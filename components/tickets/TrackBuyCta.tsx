...
export function TrackBuyCta({ variant, href = SITE_LINKS.waitlist }: TrackBuyCtaProps) {
  ...
  return (
    <div className="sticky bottom-4 z-10 mt-6">
      <Link
        href={href}
        className={`flex w-full items-center justify-center gap-2 rounded-full px-6 py-4 font-sans text-base font-semibold transition hover:scale-[1.02] hover:shadow-lg hover:shadow-[#E85520]/30 ${
          isSummit
